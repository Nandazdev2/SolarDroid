...
local function createUsing9Slice( button, options )
	...
	if opt.sheet then
		...
		local themeData = require( opt.themeData )
                printf("DEBUG: opt.themeSheetFile=" .. tostring(opt.themeSheetFile) .. " opt.themeData=" .. tostring(opt.themeData))
		imageSheet = graphics.newImageSheet( opt.themeSheetFile, system.DocumentsDirectory, themeData:getSheet() )
	end
...
function M.new( options, theme )	
        printf("DEBUG: M.new FOI CHAMADA")
	...
	-- Create the button
        printf("DEBUG REAL: using9PieceButton=" .. tostring(using9PieceButton) .. " defaultFrame=" .. tostring(opt.defaultFrame) .. " overFrame=" .. tostring(opt.overFrame) .. " textOnly=" .. tostring(opt.textOnlyButton) .. " shape=" .. tostring(opt.shape) .. " topLeftFrame=" .. tostring(opt.topLeftFrame))
	if using9PieceButton then
